...
# @Author      : junsircoding
# @File        : config/migrations/0001_initial.py
# @Info        : 
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='标题')),
                ('display_type', models.PositiveIntegerField(choices=[(1, 'HTML'), (2, '最新三篇文章'), (3, '最热三篇文章'), (4, '最近三条评论')], default=1, verbose_name='展示类型')),
